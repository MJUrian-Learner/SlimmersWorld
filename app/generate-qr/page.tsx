            ...
            {equipmentData.map((equipment) => (
              <Card key={equipment.id} className="bg-card border-border">
                <CardHeader className="text-center pb-4">
                  ...
                  <p className="text-muted-foreground text-sm">{equipment.type}</p>
                </CardHeader>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <p className="text-xs text-muted-foreground font-mono bg-muted p-2 rounded break-all">
                          {baseUrl}{equipment.url}
                        </p>
                        
                        <Button 
                          onClick={() => downloadQRCode(equipment.id, equipment.name)}
                          variant="outline" 
                          size="sm"
                          className="w-full"
                        >
            ...
            <CardContent className="p-6">
              ...
              <ol className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-start">
                  <span className="w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center text-xs font-bold mr-3 mt-0.5">1</span>
                  Click "Download QR Code" for the equipment you want to print
                </li>
                <li className="flex items-start">
                  <span className="w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center text-xs font-bold mr-3 mt-0.5">2</span>
                  Print the QR code and place it on the corresponding equipment
                </li>
                <li className="flex items-start">
                  <span className="w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center text-xs font-bold mr-3 mt-0.5">3</span>
