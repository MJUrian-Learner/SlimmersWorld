                ...
                <div className="flex flex-col justify-center">
                  ...
                  <div className="space-y-2">
                    <h4 className="font-semibold text-sm">
                      Where are dumbbells used?
                    </h4>
                    <p className="text-sm text-muted-foreground text-pretty">
                      One of the most significant benefits of exercising with
                      dumbbells is that it helps to build strength. Dumbbells
                      allow you to target and work on a wide range of muscle
                      groups. By challenging your muscles, you can increase your
